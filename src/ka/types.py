...
def register_unit(longname, symbol, measure):
    pass
...
# Function to compose units.
# Function to invert units (so divide = invert & compose).
# Need to have offset & multiplier in units, so that
# we can define derived units.
# Need "unitless" units, like radians.
# Unit prefixes.
# Non-SI units.
BASE_UNITS = [
    Unit("m", ["metres"],),
