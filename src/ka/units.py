...
register_unit("week", "week", "time", S, multiple=604800)
register_unit("fortnight", "fortnight", "time", S, multiple=1209600)
register_unit("year", "year", "time", S, multiple=31536000)
register_unit("decade", "decade", "time", S, multiple=315360000)
register_unit("century", "century", "time", S, plural_name="centuries", multiple=3153600000)
register_unit("millenium", "millenium", "time", S, multiple=31536000000)
...
register_unit("ly", "lightyear", "length", M, multiple=9.4607e15)
...
register_unit("st", "stone", "mass", KG, multiple=6.35)
